...
| 13 | 20250216 | NSA                  | Native Sparse Attention: Hardware-Aligned and Natively<br />Trainable Sparse Attention                                | [link](http://arxiv.org/abs/2502.11089) | 论文提出 NSA（Natively trainable Sparse Attention），旨在解决长上下<br />文建模中标准注意力机制计算成本高的问题。其工作要点为：<br />采用动态分层稀疏策略，结合算法创新与硬件优化；<br />设计三种注意力路径；实验验证其在保持模型性能的同时，<br />能显著提升长序列处理的效率。                                                                                                                                               | ✅[details](./deepseek-paper/13-Native_Sparse_Attention-Hardware-Aligned_and_Natively_Trainable_Sparse_Attention.md)                                                           |
